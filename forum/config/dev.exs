...
config :forum, ForumWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "psBGvjPz4qyG+PdT7q+lGecg7LtoD6T7zS5WjTSA4cFfhm/na9fvv4/N8Yo0LqeJ",
  watchers: [
...
config :forum, ForumWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/forum_web/router\.ex$"E,
      ~r"lib/forum_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
